...
const struct xlat blkpg_ops[] = {
 { (unsigned)(1), "BLKPG_ADD_PARTITION" },
 { (unsigned)(2), "BLKPG_DEL_PARTITION" },
 { (unsigned)(3), "BLKPG_RESIZE_PARTITION" },
 { 0, 0 }
};
static void
print_blkpg_req(struct tcb *tcp, const struct_blkpg_ioctl_arg *blkpg)
{
 ...
 if (!umoven_or_printaddr((tcp), ((long) blkpg->data), sizeof(*(&p)), (void *) (&p))) {
...
MPERS_PRINTER_DECL(int, block_ioctl, struct tcb *tcp, const unsigned int code, const long arg)
{
 switch (code) {
 ...
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((101)) << 0) | ((0) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04)))
   return 0;
  tprints(", ");
  printnum_long_int((tcp), (arg), "%" "l" "d", "%d");
  break;
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((96)) << 0) | ((0) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04)))
   return 0;
  tprints(", ");
  printnum_long_int((tcp), (arg), "%" "l" "u", "%u");
  break;
