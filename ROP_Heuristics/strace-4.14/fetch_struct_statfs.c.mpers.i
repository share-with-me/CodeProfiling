...
MPERS_PRINTER_DECL(_Bool, fetch_struct_statfs, struct tcb *tcp, const long addr, struct strace_statfs *p)
{
 struct_statfs b;
...
MPERS_PRINTER_DECL(_Bool, fetch_struct_statfs64, struct tcb *tcp, const long addr, const unsigned long size, struct strace_statfs *p)
{
 struct_statfs64 b;
        if (sizeof(b) != size
    ) {
