...
const struct xlat adjtimex_modes[] = {
 { (unsigned)(0), "0" },
  { (unsigned)(0x0001), "ADJ_OFFSET" },
  { (unsigned)(0x0002), "ADJ_FREQUENCY" },
  { (unsigned)(0x0004), "ADJ_MAXERROR" },
  { (unsigned)(0x0008), "ADJ_ESTERROR" },
  { (unsigned)(0x0010), "ADJ_STATUS" },
  { (unsigned)(0x0020), "ADJ_TIMECONST" },
  { (unsigned)(0x0080), "ADJ_TAI" },
  { (unsigned)(0x1000), "ADJ_MICRO" },
  { (unsigned)(0x2000), "ADJ_NANO" },
  { (unsigned)(0x4000), "ADJ_TICK" },
  { (unsigned)(0x8001), "ADJ_OFFSET_SINGLESHOT" },
  { (unsigned)(0xa001), "ADJ_OFFSET_SS_READ" },
 { 0, 0 }
};
static
const struct xlat adjtimex_status[] = {
  { (unsigned)(0x0001), "STA_PLL" },
  { (unsigned)(0x0002), "STA_PPSFREQ" },
  { (unsigned)(0x0004), "STA_PPSTIME" },
  { (unsigned)(0x0008), "STA_FLL" },
  { (unsigned)(0x0010), "STA_INS" },
  { (unsigned)(0x0020), "STA_DEL" },
  { (unsigned)(0x0040), "STA_UNSYNC" },
  { (unsigned)(0x0080), "STA_FREQHOLD" },
  { (unsigned)(0x0100), "STA_PPSSIGNAL" },
  { (unsigned)(0x0200), "STA_PPSJITTER" },
  { (unsigned)(0x0400), "STA_PPSWANDER" },
  { (unsigned)(0x0800), "STA_PPSERROR" },
  { (unsigned)(0x1000), "STA_CLOCKERR" },
  { (unsigned)(0x2000), "STA_NANO" },
  { (unsigned)(0x4000), "STA_MODE" },
  { (unsigned)(0x8000), "STA_CLK" },
 { 0, 0 }
};
MPERS_PRINTER_DECL(int, print_timex, struct tcb *tcp, const long addr)
{
 struct_timex tx;
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&tx)), (void *) (&tx)))
  return -1;
 tprints("{modes=");
