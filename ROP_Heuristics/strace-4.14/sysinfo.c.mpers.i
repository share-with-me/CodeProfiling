...
int sys_sysinfo(struct tcb *tcp)
{
 ...
 if (!umoven_or_printaddr((tcp), (tcp->u_arg[0]), sizeof(*(&si)), (void *) (&si))) {
  tprintf("{uptime=%llu"
   ...
   ", mem_unit=%u"
   "}",
   (sizeof(si.uptime) == sizeof(char) ? (unsigned long long) (unsigned char) (si.uptime) : sizeof(si.uptime) == sizeof(short) ? (unsigned long long) (unsigned short) (si.uptime) : sizeof(si.uptime) == sizeof(int) ? (unsigned long long) (unsigned int) (si.uptime) : sizeof(si.uptime) == sizeof(long) ? (unsigned long long) (unsigned long) (si.uptime) : (unsigned long long) (si.uptime))
   , (sizeof(si.loads[0]) == sizeof(char) ? (unsigned long long) (unsigned char) (si.loads[0]) : sizeof(si.loads[0]) == sizeof(short) ? (unsigned long long) (unsigned short) (si.loads[0]) : sizeof(si.loads[0]) == sizeof(int) ? (unsigned long long) (unsigned int) (si.loads[0]) : sizeof(si.loads[0]) == sizeof(long) ? (unsigned long long) (unsigned long) (si.loads[0]) : (unsigned long long) (si.loads[0]))
   , (sizeof(si.loads[1]) == sizeof(char) ? (unsigned long long) (unsigned char) (si.loads[1]) : sizeof(si.loads[1]) == sizeof(short) ? (unsigned long long) (unsigned short) (si.loads[1]) : sizeof(si.loads[1]) == sizeof(int) ? (unsigned long long) (unsigned int) (si.loads[1]) : sizeof(si.loads[1]) == sizeof(long) ? (unsigned long long) (unsigned long) (si.loads[1]) : (unsigned long long) (si.loads[1]))
   , (sizeof(si.loads[2]) == sizeof(char) ? (unsigned long long) (unsigned char) (si.loads[2]) : sizeof(si.loads[2]) == sizeof(short) ? (unsigned long long) (unsigned short) (si.loads[2]) : sizeof(si.loads[2]) == sizeof(int) ? (unsigned long long) (unsigned int) (si.loads[2]) : sizeof(si.loads[2]) == sizeof(long) ? (unsigned long long) (unsigned long) (si.loads[2]) : (unsigned long long) (si.loads[2]))
   , (sizeof(si.totalram) == sizeof(char) ? (unsigned long long) (unsigned char) (si.totalram) : sizeof(si.totalram) == sizeof(short) ? (unsigned long long) (unsigned short) (si.totalram) : sizeof(si.totalram) == sizeof(int) ? (unsigned long long) (unsigned int) (si.totalram) : sizeof(si.totalram) == sizeof(long) ? (unsigned long long) (unsigned long) (si.totalram) : (unsigned long long) (si.totalram))
   , (sizeof(si.freeram) == sizeof(char) ? (unsigned long long) (unsigned char) (si.freeram) : sizeof(si.freeram) == sizeof(short) ? (unsigned long long) (unsigned short) (si.freeram) : sizeof(si.freeram) == sizeof(int) ? (unsigned long long) (unsigned int) (si.freeram) : sizeof(si.freeram) == sizeof(long) ? (unsigned long long) (unsigned long) (si.freeram) : (unsigned long long) (si.freeram))
   , (sizeof(si.sharedram) == sizeof(char) ? (unsigned long long) (unsigned char) (si.sharedram) : sizeof(si.sharedram) == sizeof(short) ? (unsigned long long) (unsigned short) (si.sharedram) : sizeof(si.sharedram) == sizeof(int) ? (unsigned long long) (unsigned int) (si.sharedram) : sizeof(si.sharedram) == sizeof(long) ? (unsigned long long) (unsigned long) (si.sharedram) : (unsigned long long) (si.sharedram))
   , (sizeof(si.bufferram) == sizeof(char) ? (unsigned long long) (unsigned char) (si.bufferram) : sizeof(si.bufferram) == sizeof(short) ? (unsigned long long) (unsigned short) (si.bufferram) : sizeof(si.bufferram) == sizeof(int) ? (unsigned long long) (unsigned int) (si.bufferram) : sizeof(si.bufferram) == sizeof(long) ? (unsigned long long) (unsigned long) (si.bufferram) : (unsigned long long) (si.bufferram))
   , (sizeof(si.totalswap) == sizeof(char) ? (unsigned long long) (unsigned char) (si.totalswap) : sizeof(si.totalswap) == sizeof(short) ? (unsigned long long) (unsigned short) (si.totalswap) : sizeof(si.totalswap) == sizeof(int) ? (unsigned long long) (unsigned int) (si.totalswap) : sizeof(si.totalswap) == sizeof(long) ? (unsigned long long) (unsigned long) (si.totalswap) : (unsigned long long) (si.totalswap))
   , (sizeof(si.freeswap) == sizeof(char) ? (unsigned long long) (unsigned char) (si.freeswap) : sizeof(si.freeswap) == sizeof(short) ? (unsigned long long) (unsigned short) (si.freeswap) : sizeof(si.freeswap) == sizeof(int) ? (unsigned long long) (unsigned int) (si.freeswap) : sizeof(si.freeswap) == sizeof(long) ? (unsigned long long) (unsigned long) (si.freeswap) : (unsigned long long) (si.freeswap))
   , (unsigned) si.procs
   , (sizeof(si.totalhigh) == sizeof(char) ? (unsigned long long) (unsigned char) (si.totalhigh) : sizeof(si.totalhigh) == sizeof(short) ? (unsigned long long) (unsigned short) (si.totalhigh) : sizeof(si.totalhigh) == sizeof(int) ? (unsigned long long) (unsigned int) (si.totalhigh) : sizeof(si.totalhigh) == sizeof(long) ? (unsigned long long) (unsigned long) (si.totalhigh) : (unsigned long long) (si.totalhigh))
   , (sizeof(si.freehigh) == sizeof(char) ? (unsigned long long) (unsigned char) (si.freehigh) : sizeof(si.freehigh) == sizeof(short) ? (unsigned long long) (unsigned short) (si.freehigh) : sizeof(si.freehigh) == sizeof(int) ? (unsigned long long) (unsigned int) (si.freehigh) : sizeof(si.freehigh) == sizeof(long) ? (unsigned long long) (unsigned long) (si.freehigh) : (unsigned long long) (si.freehigh))
   , si.mem_unit
   );
 }
 return 0;
