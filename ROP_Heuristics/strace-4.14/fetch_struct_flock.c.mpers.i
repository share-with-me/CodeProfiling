...
MPERS_PRINTER_DECL(_Bool, fetch_struct_flock, struct tcb *tcp, const long addr, void *p)
{
 struct_kernel_flock64 *pfl = p;
 struct_flock mfl;
 if ((sizeof(struct_kernel_flock64) == sizeof(struct_flock) && (sizeof(((struct_kernel_flock64 *) ((void *)0))->l_type) == sizeof(((struct_flock *) ((void *)0))->l_type) && __builtin_offsetof (struct_kernel_flock64, l_type) == __builtin_offsetof (struct_flock, l_type)) && (sizeof(((struct_kernel_flock64 *) ((void *)0))->l_whence) == sizeof(((struct_flock *) ((void *)0))->l_whence) && __builtin_offsetof (struct_kernel_flock64, l_whence) == __builtin_offsetof (struct_flock, l_whence)) && (sizeof(((struct_kernel_flock64 *) ((void *)0))->l_start) == sizeof(((struct_flock *) ((void *)0))->l_start) && __builtin_offsetof (struct_kernel_flock64, l_start) == __builtin_offsetof (struct_flock, l_start)) && (sizeof(((struct_kernel_flock64 *) ((void *)0))->l_len) == sizeof(((struct_flock *) ((void *)0))->l_len) && __builtin_offsetof (struct_kernel_flock64, l_len) == __builtin_offsetof (struct_flock, l_len)) && (sizeof(((struct_kernel_flock64 *) ((void *)0))->l_pid) == sizeof(((struct_flock *) ((void *)0))->l_pid) && __builtin_offsetof (struct_kernel_flock64, l_pid) == __builtin_offsetof (struct_flock, l_pid))))
...
MPERS_PRINTER_DECL(_Bool, fetch_struct_flock64, struct tcb *tcp, const long addr, void *p)
{
 struct_kernel_flock64 *pfl = p;
 struct_flock64 mfl;
 if ((sizeof(struct_kernel_flock64) == sizeof(struct_flock64) && (sizeof(((struct_kernel_flock64 *) ((void *)0))->l_type) == sizeof(((struct_flock64 *) ((void *)0))->l_type) && __builtin_offsetof (struct_kernel_flock64, l_type) == __builtin_offsetof (struct_flock64, l_type)) && (sizeof(((struct_kernel_flock64 *) ((void *)0))->l_whence) == sizeof(((struct_flock64 *) ((void *)0))->l_whence) && __builtin_offsetof (struct_kernel_flock64, l_whence) == __builtin_offsetof (struct_flock64, l_whence)) && (sizeof(((struct_kernel_flock64 *) ((void *)0))->l_start) == sizeof(((struct_flock64 *) ((void *)0))->l_start) && __builtin_offsetof (struct_kernel_flock64, l_start) == __builtin_offsetof (struct_flock64, l_start)) && (sizeof(((struct_kernel_flock64 *) ((void *)0))->l_len) == sizeof(((struct_flock64 *) ((void *)0))->l_len) && __builtin_offsetof (struct_kernel_flock64, l_len) == __builtin_offsetof (struct_flock64, l_len)) && (sizeof(((struct_kernel_flock64 *) ((void *)0))->l_pid) == sizeof(((struct_flock64 *) ((void *)0))->l_pid) && __builtin_offsetof (struct_kernel_flock64, l_pid) == __builtin_offsetof (struct_flock64, l_pid))))
  return !umoven_or_printaddr((tcp), (addr), sizeof(*(pfl)), (void *) (pfl));
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&mfl)), (void *) (&mfl)))
  return 0;
 pfl->l_type = mfl.l_type;
