...
int sys_times(struct tcb *tcp)
{
 ...
 if ((!((tcp)->flags & 0x04)))
  return 0;
 if (!umoven_or_printaddr((tcp), (tcp->u_arg[0]), sizeof(*(&tbuf)), (void *) (&tbuf))) {
  tprintf("{tms_utime=%llu, tms_stime=%llu, ",
   (sizeof(tbuf.tms_utime) == sizeof(char) ? (unsigned long long) (unsigned char) (tbuf.tms_utime) : sizeof(tbuf.tms_utime) == sizeof(short) ? (unsigned long long) (unsigned short) (tbuf.tms_utime) : sizeof(tbuf.tms_utime) == sizeof(int) ? (unsigned long long) (unsigned int) (tbuf.tms_utime) : sizeof(tbuf.tms_utime) == sizeof(long) ? (unsigned long long) (unsigned long) (tbuf.tms_utime) : (unsigned long long) (tbuf.tms_utime)),
   (sizeof(tbuf.tms_stime) == sizeof(char) ? (unsigned long long) (unsigned char) (tbuf.tms_stime) : sizeof(tbuf.tms_stime) == sizeof(short) ? (unsigned long long) (unsigned short) (tbuf.tms_stime) : sizeof(tbuf.tms_stime) == sizeof(int) ? (unsigned long long) (unsigned int) (tbuf.tms_stime) : sizeof(tbuf.tms_stime) == sizeof(long) ? (unsigned long long) (unsigned long) (tbuf.tms_stime) : (unsigned long long) (tbuf.tms_stime)));
  tprintf("tms_cutime=%llu, tms_cstime=%llu}",
   (sizeof(tbuf.tms_cutime) == sizeof(char) ? (unsigned long long) (unsigned char) (tbuf.tms_cutime) : sizeof(tbuf.tms_cutime) == sizeof(short) ? (unsigned long long) (unsigned short) (tbuf.tms_cutime) : sizeof(tbuf.tms_cutime) == sizeof(int) ? (unsigned long long) (unsigned int) (tbuf.tms_cutime) : sizeof(tbuf.tms_cutime) == sizeof(long) ? (unsigned long long) (unsigned long) (tbuf.tms_cutime) : (unsigned long long) (tbuf.tms_cutime)),
   (sizeof(tbuf.tms_cstime) == sizeof(char) ? (unsigned long long) (unsigned char) (tbuf.tms_cstime) : sizeof(tbuf.tms_cstime) == sizeof(short) ? (unsigned long long) (unsigned short) (tbuf.tms_cstime) : sizeof(tbuf.tms_cstime) == sizeof(int) ? (unsigned long long) (unsigned int) (tbuf.tms_cstime) : sizeof(tbuf.tms_cstime) == sizeof(long) ? (unsigned long long) (unsigned long) (tbuf.tms_cstime) : (unsigned long long) (tbuf.tms_cstime)));
 }
 return ((tcp)->u_error != 0) ? 000 :
          003;
}
